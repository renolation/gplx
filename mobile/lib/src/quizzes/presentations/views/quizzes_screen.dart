    ...
    return Scaffold(
      appBar: AppBar(
        ...
        actions: [
          ...
          TextButton(
              onPressed: () {}, child: Text(SettingsBox().vehicleTypeQuestion)),
        ],
      ),
        ...
        builder: (context, state) {
          if (state is QuizzesLoading) {
            ...
            return ValueListenableBuilder(
                valueListenable:
                    Hive.box(BoxKeys.hiveQuestionsBox).listenable(),
                builder: (context, box, _) {
                  List<QuizModel> listQuizzes =
                      QuestionsBox().listQuizzes.isEmpty
                          ? state.quizzes
                          : QuestionsBox().listQuizzes;
                  listQuizzes.sort((a, b) => a.id.compareTo(b.id));
                  listQuizzes = [...listQuizzes.where((e) => e.type == SettingsBox().vehicleTypeQuestion)];
                  return Padding(
